...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PA3     ------> ADC3_IN3
    */
    HAL_GPIO_DeInit(GPIOF, ADC3_09_R4_Pin|ADC3_15_R5_Pin|ADC3_08_R6_Pin);

    HAL_GPIO_DeInit(GPIOC, ADC3_10_R2_Pin|ADC3_13_R3_Pin);

    HAL_GPIO_DeInit(ADC3_03_R1_GPIO_Port, ADC3_03_R1_Pin);
